...
$(function(){
 ...
 $(".group2_1").colorbox({rel:'group2_1', hasSecondFlg: false, title:"S/S 2014", onOpen:pauseCycle, onClosed:resumeCycle});
 $(".group2_2").colorbox({rel:'group2_2', hasSecondFlg: false, title:"A/W 2013", onOpen:pauseCycle, onClosed:resumeCycle});
 $(".group2_3").colorbox({rel:'group2_3', hasSecondFlg: false, title:"S/S 2013", onOpen:pauseCycle, onClosed:resumeCycle});
 $(".group2_4").colorbox({rel:'group2_4', hasSecondFlg: false, title:"A/W 2012", onOpen:pauseCycle, onClosed:resumeCycle});
 $(".group2_5").colorbox({rel:'group2_5', hasSecondFlg: false, title:"S/S 2012", onOpen:pauseCycle, onClosed:resumeCycle});
 $(".group2_6").colorbox({rel:'group2_6', hasSecondFlg: false, title:"A/W 2011", onOpen:pauseCycle, onClosed:resumeCycle});
