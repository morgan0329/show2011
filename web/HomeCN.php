...
$(function(){
 ...
 $(".group2_1").colorbox({language:'cn', rel:'group2_1', hasSecondFlg: false, title:"2012 秋冬", onOpen:pauseCycle, onClosed:resumeCycle});
 $(".group2_2").colorbox({language:'cn', rel:'group2_2', hasSecondFlg: false, title:"2012 春夏", onOpen:pauseCycle, onClosed:resumeCycle});
 $(".group2_3").colorbox({language:'cn', rel:'group2_3', hasSecondFlg: false, title:"2011 秋冬", onOpen:pauseCycle, onClosed:resumeCycle});
...
<?php  
$arr1 = array(
  array("group1_1", "./images/NewArrival/", "最新产品"),
  array("group1_2", "./images/NaturalWorld/", "手工经典"),
  array("group1_3", "./images/LadyElegance/", "雅致俪人"),
  array("group1_4", "./images/CitySenior/", "都市白领"),
  array("group1_5", "./images/FashionTrend/", "时尚先锋"));
...
<?php  
$arr = array(
  array("group2_1", "./images/2012AW/", "2012 秋冬"),
  array("group2_2", "./images/2012SS/", "2012 春夏"),
  array("group2_3", "./images/2011FW/", "2011 秋冬"));
